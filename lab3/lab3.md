...
SELECT * FROM Users;
```
![All users](selectusers.jpg)

### 1.2 Показ всіх статей
```sql
SELECT * FROM Articles;
```
![All articles](selectarticles.jpg)

### 1.3 Показ всіх категорій
```sql
SELECT * FROM Categories;
```
![All categories](selectcategories.jpg)
...
WHERE IsAdmin = FALSE;
```
![All non admin users' emails](select_emails.jpg)
...
WHERE UserID = 3;
```
![All articles from user with UserID 3](select_userid3.jpg)
...
```
![All categories from article with ArticleID 2](select_categories.jpg)
...
SELECT * FROM Users;
```
![Insert new users](insert_users.jpg)
![Insert new users2](insert_users2.jpg)
...
```
![Insert new article](insert_silksong.jpg)
![Insert new article2](insert_silksong2.jpg)


### 2.3 Додавання нової статті в таблицю та категорії
```sql
...
SELECT * FROM Categories;
```
![Insert new category](insert_chem.jpg)
...
WHERE ArticleID = 1;
```
![Update c++ article to java](update_java.jpg)
...
SELECT * FROM Users;
```
![Update userid3 admin](update_admin.jpg)
...
SELECT * FROM Articles;
```
![userid2 delete artciles](delete_articles.jpg)
...
SELECT * FROM Users;
```
![userid2 delete](delete_user.jpg)
...
SELECT * FROM Categories;
```
![chemistry category delete](delete_chem.jpg)
...
SELECT * FROM ArticleCategory;
```
![article2 category delete](delete_2article.jpg)
