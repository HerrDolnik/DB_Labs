...
- Адміністратор - це користувач, який має атрибут доступу для керування категоріями та модерації статей;
...
- ідентифікатори;
- наявність адміністративних привілеїв.
...
- **IsAdmin** - наявність адміністративних привілеїв у користувача.
...
## Висновок
На даній лабораторній роботи я створював ER-діаграму на основі вимог для реалізації сценарію у вигляді веб-енциклопедії. По ходу її виконання були визначені вимоги для створення бази даних для веб-енциклопедії, а саме завдання користувачів, бізнес-правила та дані, які будуть зберігатися. На основі даних вимог були побудовані сутності та зв'язки між ними, які згодом були зображені на ER-діаграмі.