# Лабораторні роботи з дисципліни «Основи баз даних»

## Обраний сценарій для бази даних: **Веб-енциклопедія**

Лабораторні роботи виконував студент групи ІО-44 **Дольник Артем**

### Лабораторна робота №1: Створення ER-діаграми
Шлях до звіту: [***lab1/lab1.md***](https://github.com/HerrDolnik/DB_Labs/blob/main/lab1/lab1.md)
### Лабораторна робота №2: Створення схеми в PostgreSQL на основі ER-діаграми
Шлях до звіту: [***lab2/lab2.md***](https://github.com/HerrDolnik/DB_Labs/blob/main/lab2/lab2.md)
